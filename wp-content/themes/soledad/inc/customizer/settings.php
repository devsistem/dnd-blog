...
function pencidesign_register_theme_customizer( $wp_customize ) {
	...
	$wp_customize->add_setting( 'penci_woo_disable_slider_gallery', array(
		'default'           => false,
		'sanitize_callback' => 'penci_sanitize_checkbox_field'
	) );
	...
	$wp_customize->add_control( new WP_Customize_Control( $wp_customize, 'woo_disable_slider_gallery', array(
		'label'    => 'Disable Slider on Gallery Product',
		'section'  => 'pencidesign_new_section_woocommerce',
		'settings' => 'penci_woo_disable_slider_gallery',
		'type'     => 'checkbox',
		'priority' => 23
	) ) );
